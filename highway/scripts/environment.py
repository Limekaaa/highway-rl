...
from shared_core_config import SHARED_CORE_CONFIG, SHARED_CORE_ENV_ID, TEST_CONFIG, CNN_TEST_CONFIG, CNN_TRAIN_CONFIG
...
def get_env(seed=None, config_type=ConfigType.TEST):
    ...
    config = (
        ...
        CNN_TRAIN_CONFIG if config_type == ConfigType.TRAIN_CNN
        else None)
